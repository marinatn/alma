<?php
	...
	$_SESSION['errmsg']="Пароль успешно изменен";
	exit();
	}
	else
	{
	...
	$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
	header("location:http://$host$uri/$extra");
	$_SESSION['errmsg']="Неверный адрес электронной почты или контактный номер";
	exit();
	}
	}
?>
							...
							<div class="col-md-6 col-sm-6 sign-in">
								...
								<form class="register-form outer-top-xs" name="register" method="post">
									...
									<div class="form-group">
								  	...
								  	<div class="form-group">
									   <label class="info-title" for="exampleInputPassword1">Номер телефона 
									   	<span>*</span>
									   </label>
									...
									<div class="form-group">
										   <label class="info-title" for="confirmpassword">Подтвердите пароль 
										   	<span>*</span>
										   </label>
										   <input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
									</div> <!-- /.form-group -->

									<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="change">Изменить пароль</button>
								</form>					
