						...
						<div class="col-md-12 my-wishlist">
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th colspan="4">Мой список желаний</th>
										</tr>
									</thead>
									...
									<tbody>
										...
										<tr>
											<td style="font-size: 18px; font-weight:bold ">Ваш список пожеланий пуст</td>
										</tr>
										<?php } ?>
									</tbody>
								</table>
							</div> <!-- /.table-responsive -->
						</div>	<!-- /.col-md-12 my-wishlist	 -->	
					</div><!-- /.row -->
				</div><!-- /.my-wishlist-page inner-bottom-sm-->
