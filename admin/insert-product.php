...
<head>
	...
	<title>Админ| Добавление товаров</title>
...
{?>
									<div class="alert alert-error">
										<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>Что-то пошло не так!</strong> 	<?php echo htmlentities($_SESSION['delmsg']);?><?php echo htmlentities($_SESSION['delmsg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Название товара</label>
<div class="controls">
<input type="text"    name="productName"  placeholder="Введите название товара" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Введите название бренда/производителя" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Цена до скидки</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Введите стоимость товара" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Введите стоимость товара" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Введите описание товара" rows="6" class="span8 tip">
</textarea>  
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Введите стоимость доставки" class="span8 tip" required>
</div>
</div>
