...
<head>
	...
	<title>Админ | Редактирование категорий </title>
...
<label class="control-label" for="basicinput">Название</label>
<div class="controls">
<input type="text" placeholder="Введите название категории"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
