...
<head>
	...
	<title>Админ | Заказы в ожидании</title>
...
?>										
										<tr>
											...
											<td>    <a href="updateorder.php?oid=<?php echo htmlentities($row['id']);?>" title="Обновление заказа" target="_blank"><i class="icon-edit"></i></a>
											</td>
											</tr>
