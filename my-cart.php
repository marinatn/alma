			...
			<div class="container">
				<div class="row inner-bottom-sm">
					<div class="shopping-cart">
							...
							<div class="table-responsive">
								<form name="cart" method="post">	
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												<th class="cart-romove item">Выбрать товар</th>
												...
												<th class="cart-sub-total item">Цена за шт.</th>
												<th class="cart-sub-total item">Стоимость доставки</th>
												<th class="cart-total last-item">Общий итог</th>
											</tr>
										</thead><!-- /thead -->	
										...
										<tbody>
											...
											<tr>
												...
												<td class="cart-product-sub-total">
													<span class="cart-sub-total-price"><?php echo "₽"." ".$row['productPrice']; ?>.00</span>
												</td>
						...
						</div> <!-- /.col-md-4 col-sm-12 estimate-ship-tax -->
						...
						<div class="col-md-4 col-sm-12 estimate-ship-tax">
							<table class="table table-bordered">
								<thead>
									<tr>
										<th>
											<span class="estimate-title">Платежная система</span>
										</th>
									</tr>
								</thead>
									...
									<tr>
										<th>
											<div class="cart-grand-total">
												Итог<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
											</div>
										</th>
									</tr>
								</thead><!-- /thead -->
						...
						</div>	<!-- /.col-md-4 col-sm-12 cart-shopping-total	 -->	
					</div> 
		</div> 
		</form>
