			...
			<div class="container">
				<div class="row inner-bottom-sm">
					<div class="shopping-cart">
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th class="cart-product-name item">Название товара</th>
										
												<th class="cart-qty item">Количество</th>
												<th class="cart-sub-total item">Цена за штуку</th>
												<th class="cart-total item">Общий итог</th>
												<th class="cart-total item">Способ оплаты</th>
												<th class="cart-description item">Дата заказа</th>
												<th class="cart-total last-item">Действия</th>
											</tr>
										</thead><!-- /thead -->
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/shopping/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">Отслеживание
												</td>
											</tr>
											<?php $cnt=$cnt+1;} } else { ?>
															<tr>
																<td colspan="8">Идентификатор заказа или адрес электронной почты недействителен</td>
															</tr>
															<?php } ?>
										</tbody><!-- /tbody -->
									</table><!-- /table -->
						...
						</div> <!-- /.col-md-12 col-sm-12 shopping-cart-table -->
					</div><!-- /.shopping-cart -->
				</div> <!-- /.row inner-bottom-sm-->
