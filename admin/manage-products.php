...
<head>
	...
	<title>Админ | Управление товарами</title>
...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Вы уверены, что хотите удалить товар?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
