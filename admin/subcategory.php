...
$_SESSION['msg']="Подкатегория добавлена!!";
...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="Подкатегория удалена!!";
		  }
...
<div class="controls">
<input type="text" placeholder="Введите название подкатегории"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Вы уверены, что хотите удалить подкатегорию?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
