						...
						<div class="sidebar-module-container">
							<!-- ==============================================CATEGORY============================================== -->
								<div class="sidebar-widget outer-bottom-xs wow fadeInUp">
									...
									</div> <!-- /.sidebar-widget-body m-t-10 -->
								</div> <!-- /.sidebar-widget outer-bottom-xs wow fadeInUp -->
							<!-- ============================================== CATEGORY : END ============================= -->					
							<!-- ============================================== HOT DEALS START ======================== -->
								<div class="sidebar-widget hot-deals wow fadeInUp">
									<h3 class="section-title">Хит продаж</h3>
									<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
										...
										<div class="item">
											<div class="products">
												...
												</div><!-- /.product-info text-left m-t-20-->
												...
												</div><!-- /.cart learfix animate-effect-->
											</div>	<!-- /.products -->
										</div>		<!-- /.item -->
										<?php } ?>    
									</div><!-- /.owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs-->
								</div> <!-- /.sidebar-widget hot-deals wow fadeInUp -->
							<!-- =============================== HOT DEALS END============================================== -->
						...
						<div class="row  wow fadeInUp">
							<div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
		    					<div class="product-item-holder size-big single-product-gallery small-gallery">
									...
									</div> <!-- /.single-product-gallery-thumbs gallery-thumb -->
							    </div> <!-- /.product-item-holder size-big single-product-gallery small-gallery -->
							</div>     <!-- /.col-xs-12 col-sm-6 col-md-5 gallery-holder		 -->	
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									...
									</div>	<!-- /.stock-container info-container m-t-10 -->
									<div class="stock-container info-container m-t-10">
										<div class="row">
											<div class="col-sm-3">
												<div class="stock-box">
									...
									<div class="stock-container info-container m-t-10">
										<div class="row">
											<div class="col-sm-3">
												<div class="stock-box">
													<span class="label">Стоимость <br> доставки :</span>
												</div>	
											</div> <!-- /.col-sm-3 -->
									...
									<div class="price-container info-container m-t-20">
										<div class="row">
											...
											<div class="col-sm-6">
												...
												</div> <!-- /.favorite-button m-t-10 -->
											</div> <!-- /.col-sm-6 -->
										</div><!-- /.row -->
									</div><!-- /.price-container info-container m-t-20-->
												...
												<div class="cart-quantity">
													<div class="quant-input">
										                <div class="arrows">
											                ...
											                </div><!--  /.arrow plus gradient -->

											                <div class="arrow minus gradient">
											                	<span class="ir">
											                		<i class="icon fa fa-sort-desc"></i>
											                	</span>
											                </div>	<!--  /.arrow minus gradient -->
										                </div> <!-- /.arrows -->
									...
									</div><!-- /.quantity-container info-container-->
									...
									</div>	<!--  /.product-social-link m-t-20 text-right -->
								</div><!-- /.product-info -->
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								...
								<li><a data-toggle="tab" href="#review">ОБЗОР</a></li>
										...
										<div class="product-reviews">
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Quality :</b>  <?php echo htmlentities($rvw['quality']);?> Звезда</div>
													<div class="text"><b>Price :</b>  <?php echo htmlentities($rvw['price']);?> Звезда</div>
													<div class="text"><b>value :</b>  <?php echo htmlentities($rvw['value']);?> Звезда</div>
												...
												<div class="review-table">
													<div class="table-responsive">
														<table class="table table-bordered">	
															...
															<tbody>
																<tr>
																	<td class="cell-label">Качество</td>
																...
																<tr>
																	<td class="cell-label">Целостность</td>
													...
													<div class="form-container">
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Номер заказа 
																		<span class="astk">*</span>
																	</label>
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Комментарий 
																		<span class="astk">*</span>
																	</label>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Добавить в корзину</a>
