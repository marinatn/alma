...
<html lang="ru">
	<head>
	    ...
	    <title>История ожидающих заказов</title>
												...
												<td colspan="9">
													<div class="cart-checkout-btn pull-right">
														<button type="submit" name="ordersubmit" class="btn btn-primary">
															<a href="payment-method.php">ПЕРЕЙТИ К ОПЛАТЕ</a>
														</button>
													</div> <!-- /.cart-checkout-btn pull-right -->
												</td>
											</tr>
											<?php } else {?>
											<tr>
												<td colspan="10" align="center"><h4>Результатов не найдено</h4></td>
											</tr>
											<?php } ?>
										</tbody><!-- /tbody -->
									</table><!-- /table -->
