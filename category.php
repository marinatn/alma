...
<html lang="ru">
	<head>
	    ...
	    <title>Каталог натуральной косметики Альма</title>
					...
					<div class='col-md-3 sidebar'>
			            <!-- ================================== TOP NAVIGATION ================================== -->
							<div class="side-menu animate-dropdown outer-bottom-xs">       
								<div class="side-menu animate-dropdown outer-bottom-xs">
							    	<div class="head">
							    		<i class="icon fa fa-align-justify fa-fw"></i>Каталог
							    	</div>    <!--  /.head    -->
								...
								</div> <!-- /.side-menu animate-dropdown outer-bottom-xs -->
							</div><!-- /.side-menu animate-dropdown outer-bottom-xs -->
						<!-- ================================== TOP NAVIGATION : END ================================== -->	 
						<div class="sidebar-module-container">
			            	<h3 class="section-title">Выбирай и покупай</h3>
			            	<div class="sidebar-filter">
				            	<!-- ============================== SIDEBAR CATEGORY ================================ -->
									<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
										<div class="widget-header m-t-20">
											<h4 class="widget-title">Категории</h4>
										</div> <!-- /.widget-header m-t-20 -->
										...
										<div class="sidebar-widget-body m-t-10">
	    									...
	    									<?php } ?>
										</div><!-- /.sidebar-widget-body m-t-20-->
									</div><!-- /.sidebar-widget wow fadeInUp outer-bottom-xs -->
									<!-- ============================= COLOR: END =================================== -->
							</div><!-- /.sidebar-filter -->
					    </div><!-- /.sidebar-module-container -->
					</div><!-- /.col-md-3 sidebarr -->
							...
							<div class="item">	
								...
								<div class="container-fluid">
									<div class="caption vertical-top text-left">
										...
										</div> <!-- /.excerpt hidden-sm hidden-md -->
										<?php } ?>
									</div><!-- /.caption vertical-top text-left -->
								</div><!-- /.container-fluid -->
							</div> <!-- /.item -->
						</div> <!-- /.category -->
								...
								<div class="tab-pane active " id="grid-container">
									<div class="category-product  inner-top-vs">
										<div class="row">									
											...
											</div> <!-- /.col-sm-6 col-md-4 wow fadeInUp -->
	  										<?php } } else {?>
