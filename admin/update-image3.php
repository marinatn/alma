...
$_SESSION['msg']="Изображение товара изменено!!";
...
<head>
	...
	<title>Админ | Редактор фото товара</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Редактирование фотографии товара 3</h3>
							</div>
...
{?>
									...
									<strong>Успех!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Текущая фотография товара</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новая фотография товара</label>
<div class="controls">
